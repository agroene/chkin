...
#### Admin Portal (All Implemented)
- Audit logs capture GRANT_CONSENT/REVOKE_CONSENT actions
- Audit log filtering by action type exists
- Form Templates section on provider detail page with consent configs
- Consent Compliance Dashboard (`/admin/consent`):
  - Summary stats: total, active, expiring, expired consents
  - Auto-renewal and withdrawal rate metrics
  - Organization breakdown with health scores
