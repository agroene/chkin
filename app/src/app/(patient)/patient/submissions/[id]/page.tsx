      ...
      <div className="mx-auto max-w-lg px-4 py-6 space-y-6">
        ...
        {submission.pdfSigning?.hasPdf && (
          <div className="rounded-xl bg-white p-4 shadow-sm">
            ...
            {submission.pdfSigning.isSigned ? (
              <div className="rounded-lg border border-green-200 bg-green-50 p-3">
                <div className="flex items-center justify-between">
                  ...
                  {submission.pdfSigning.signedDocumentUrl && (
                    <a
                      href={submission.pdfSigning.signedDocumentUrl}
                      target="_blank"
                ...
                {submission.pdfSigning.signedAt && (
                  <p className="mt-2 text-sm text-green-600">
                    Signed on {formatDate(submission.pdfSigning.signedAt)}
                  </p>
                )}
              </div>
            ) : (
              <div className="rounded-lg border border-yellow-200 bg-yellow-50 p-3">
                ...
                <p className="mt-2 text-sm text-yellow-600">
                  This document requires your signature. You can sign it from the check-in screen.
                </p>
              </div>
            )}
          </div>
