...
const addressFields: FieldDefinitionSeed[] = [
  ...
  },
  {
    ...
    description: "Postal address line 1 (if different from residential)",
    fieldType: "text",
    category: "address",
    config: { maxLength: 200 },
    sortOrder: 9,
  ...
  },
  {
    ...
    description: "GPS coordinates of the address (latitude, longitude)",
    fieldType: "text",
    category: "address",
    config: { placeholder: "-33.9249, 18.4241" },
    sortOrder: 14,
  },
];
...
const emergencyFields: FieldDefinitionSeed[] = [
  ...
  },
  {
    ...
    description: "Street address of emergency contact",
    fieldType: "text",
    category: "emergency",
    config: { maxLength: 200 },
    sortOrder: 5,
  ...
  {
    name: "emergencyContactAddressGPS",
    label: "Emergency Contact GPS",
    description: "GPS coordinates of emergency contact address",
    fieldType: "text",
    category: "emergency",
    config: { placeholder: "-33.9249, 18.4241" },
    sortOrder: 12,
...
const responsibleFields: FieldDefinitionSeed[] = [
  ...
  },
  {
    ...
    description: "Street address of responsible party",
    fieldType: "text",
    category: "responsible",
    config: { maxLength: 200 },
    sortOrder: 6,
  ...
  {
    name: "responsiblePartyAddressGPS",
    label: "Responsible Party GPS",
    description: "GPS coordinates of responsible party address",
    fieldType: "text",
    category: "responsible",
    config: { placeholder: "-33.9249, 18.4241" },
    sortOrder: 13,
...
const legalFields: FieldDefinitionSeed[] = [
  ...
  {
    name: "billingAddressGPS",
    label: "Billing Address GPS",
    description: "GPS coordinates of billing address",
    fieldType: "text",
    category: "legal",
    config: { placeholder: "-33.9249, 18.4241" },
    sortOrder: 24,
